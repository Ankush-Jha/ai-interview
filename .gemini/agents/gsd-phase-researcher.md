...
```bash
node ./.gemini/get-shit-done/bin/gsd-tools.js websearch "your query" --limit 10
```
...
```bash
node ./.gemini/get-shit-done/bin/gsd-tools.js commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
