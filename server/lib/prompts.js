...
"action": one of "follow_up" | "next_question" | "wrap_up" | "repeat_question" | "off_topic"
  ...
  - "follow_up" DEFAULT CHOICE — ask a follow-up to probe deeper, explore edge cases, or test understanding. Real interviewers almost always dig deeper. Use this for scores 1-7.
  - "next_question" ONLY if score >= 8 (truly excellent, comprehensive answer — nothing left to probe)
  - "wrap_up" only if this is the last question
"followUpQuestion": (only if action is "follow_up") A probing question based on THEIR answer. Be specific, referencing what they said. Explore a different angle, edge case, or practical application.
  GOOD: "Interesting — you mentioned closures capture variables. What happens if that variable is mutated after the closure is created?"
  GOOD: "Nice! How would you handle this differently if the input could be null or undefined?"
